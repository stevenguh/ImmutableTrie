...
{
    public abstract class ImmutableTrieListTestBase : SimpleElementImmutablesTestBase
    {
        ...
        internal abstract ImmutableTrieListBase<T> GetListQuery<T>(ImmutableTrieList<T> list);

        [Fact]
        public void CopyToEmptyTest()
        {
            var array = new int[0];
            this.GetListQuery(ImmutableTrieList<int>.Empty).CopyTo(array);
            this.GetListQuery(ImmutableTrieList<int>.Empty).CopyTo(array, 0);
            this.GetListQuery(ImmutableTrieList<int>.Empty).CopyTo(0, array, 0, 0);
            ((ICollection)this.GetListQuery(ImmutableTrieList<int>.Empty)).CopyTo(array, 0);
        }
        ...
        {
            this.GetListQuery(ImmutableTrieList<int>.Empty).ForEach(n => { throw new ShouldNotBeInvokedException(); });

            var list = ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(5, 3));
        ...
        {
            Assert.False(this.GetListQuery(ImmutableTrieList<int>.Empty).Exists(n => true));

            var list = ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(1, 5));
        ...
        {
            Assert.True(this.GetListQuery(ImmutableTrieList<int>.Empty).FindAll(n => true).IsEmpty);
            var list = ImmutableTrieList<int>.Empty.AddRange(new[] { 2, 3, 4, 5, 6 });
        ...
        {
            Assert.Equal(0, this.GetListQuery(ImmutableTrieList<int>.Empty).Find(n => true));
            var list = ImmutableTrieList<int>.Empty.AddRange(new[] { 2, 3, 4, 5, 6 });
        ...
        {
            Assert.Equal(0, this.GetListQuery(ImmutableTrieList<int>.Empty).FindLast(n => { throw new ShouldNotBeInvokedException(); }));
            var list = ImmutableTrieList<int>.Empty.AddRange(new[] { 2, 3, 4, 5, 6 });
        ...
        {
            Assert.Equal(-1, this.GetListQuery(ImmutableTrieList<int>.Empty).FindIndex(n => true));
            Assert.Equal(-1, this.GetListQuery(ImmutableTrieList<int>.Empty).FindIndex(0, n => true));
            Assert.Equal(-1, this.GetListQuery(ImmutableTrieList<int>.Empty).FindIndex(0, 0, n => true));

            // Create a list with contents: 100,101,102,103,104,100,101,102,103,104
            var list = ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(100, 5).Concat(Enumerable.Range(100, 5)));
        ...
        {
            Assert.Equal(-1, this.GetListQuery(ImmutableTrieList<int>.Empty).FindLastIndex(n => true));
            Assert.Equal(-1, this.GetListQuery(ImmutableTrieList<int>.Empty).FindLastIndex(0, n => true));
            Assert.Equal(-1, this.GetListQuery(ImmutableTrieList<int>.Empty).FindLastIndex(0, 0, n => true));
        ...
        {
            Assert.True(this.GetListQuery(ImmutableTrieList<int>.Empty).ConvertAll<float>(n => n).IsEmpty);
            var list = ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(5, 10));
        ...
        {
            Assert.True(this.GetListQuery(ImmutableTrieList<int>.Empty).GetRange(0, 0).IsEmpty);
            var list = ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(5, 10));
            var bclList = list.ToList();
        ...
        {
            Assert.True(this.GetListQuery(ImmutableTrieList<int>.Empty).TrueForAll(n => false));
            var list = ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(5, 10));
        ...
        {
            Assert.Throws<ArgumentNullException>("comparison", () => this.SortTestHelper(ImmutableTrieList<int>.Empty, (Comparison<int>)null));
        }
        ...
        {
            var scenarios = new[] {
                ImmutableTrieList<int>.Empty,
                ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(1, 50)),
                ImmutableTrieList<int>.Empty.AddRange(Enumerable.Range(1, 50).Reverse()),
            };
        ...
        public void BinarySearch()
        {
            ...
            var query = this.GetListQuery(basis.ToImmutableTrieList());
        ...
        private void BinarySearchPartialSortedListHelper(ImmutableArray<int> inputData, int sortedIndex, int sortedLength)
        {
            ...
            var query = this.GetListQuery(inputData.ToImmutableTrieList());
        ...
        protected abstract void RemoveAllTestHelper<T>(ImmutableTrieList<T> list, Predicate<T> test);

        protected abstract void ReverseTestHelper<T>(ImmutableTrieList<T> list, int index, int count);

        protected abstract List<T> SortTestHelper<T>(ImmutableTrieList<T> list);

        protected abstract List<T> SortTestHelper<T>(ImmutableTrieList<T> list, Comparison<T> comparison);

        protected abstract List<T> SortTestHelper<T>(ImmutableTrieList<T> list, IComparer<T> comparer);

        protected abstract List<T> SortTestHelper<T>(ImmutableTrieList<T> list, int index, int count, IComparer<T> comparer);
