...
{
    public abstract class ImmutableTrieDictionaryBuilderTestBase : ImmutablesTestBase
    {
        [Fact]
        public void Add()
        {
        ...
        protected abstract ImmutableTrieDictionary<string, TValue> Empty<TValue>(StringComparer comparer);
    }
}
