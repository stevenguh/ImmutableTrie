...
/*
        ...
        public void AddRangeOptimizationsTest()
        {
            ...
            var emptyList = ImmutableTrieList.Create<string>();
            ...
            var nonEmptyListDefaultComparer = ImmutableTrieList.Create("5");
...
/*
        ...
        public void InsertRangeRandomBalanceTest()
        {
            ...
            var ImmutableTrieList = ImmutableTrieList.CreateBuilder<int>();
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                ImmutableTrieList.InsertRange(startPosition, values);
                list.InsertRange(startPosition, values);

                Assert.Equal(list, ImmutableTrieList);
                ImmutableTrieList.Root.VerifyBalanced();
            }

            ImmutableTrieList.Root.VerifyHeightIsWithinTolerance();
        }
*/
        [Fact]
...
/*
        ...
        {
            var list = ImmutableTrieList.Create(1);
...
/*
        private static void VerifyBalanced<T>(ImmutableTrieList<T> tree)
        {
