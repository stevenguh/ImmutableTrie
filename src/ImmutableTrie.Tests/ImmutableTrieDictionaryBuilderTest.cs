...
{
    public class ImmutableTrieDictionaryBuilderTest : ImmutableTrieDictionaryBuilderTestBase
    {
        [Fact]
        ...
        {
            var builder = ImmutableTrieDictionary<int, string>.Empty.ToBuilder();
            builder.Add(3, "3");
            builder.Add(5, "5");
        ...
        {
            var set = ImmutableTrieDictionary<int, string>.Empty.Add(1, "1");
        ...
        {
            var mutable = ImmutableTrieDictionary<int, string>.Empty.ToBuilder();
        ...
        {
            var builder = ImmutableTrieDictionary<int, string>.Empty
        ...
        {
            var collection = ImmutableTrieDictionary<int, string>.Empty.Add(1, null);
        ...
        {
            return ((ImmutableTrieDictionary<TKey, TValue>.Builder)dictionary).TryGetKey(equalKey, out actualKey);
        }

        protected override IDictionary<TKey, TValue> GetBuilder<TKey, TValue>(IImmutableDictionary<TKey, TValue> basis)
        {
            return ((ImmutableTrieDictionary<TKey, TValue>)(basis ?? GetEmptyImmutableDictionary<TKey, TValue>())).ToBuilder();
        }
    }
}
